...
class SpecialEvent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return EventDetailsPage(
      event: EventModel(
        title: "Kamila's Wedding",
        date: DateTime(2024, 6, 15),
        time: TimeOfDay(hour: 19, minute: 00),
        location: "Sunset Ballroom, 123 Party Street",
        description:
            "Join us for an unforgettable celebration of Kamila's special day! We'll have great memories to last a lifetime.",
        guests: 450,
        budget: 5000000,
        tasks: [
        ...
        invitedGuests: [
          GuestModel(name: "Chance KARAMBIZI", status: GuestStatus.confirmed),
          GuestModel(name: "Christopher GAKWAYA", status: GuestStatus.pending),
          GuestModel(name: "Daniel IRYIVUZE", status: GuestStatus.declined),
        ],
      ),
    );
  }
    ...
    return FloatingActionButton(
      onPressed: () {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(const SnackBar(content: Text('Edit Event')));
      },
